# -*- coding: utf-8 -*-
#
# pytest-summaries documentation build configuration file, created by
...
project = 'pytest-summaries'
copyright = '2015, Mathanraj-Sharma'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-summaries Documentation',
     [author], 1)
]
